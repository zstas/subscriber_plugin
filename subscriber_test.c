/*
 * subscriber.c - subscriber vpp-api-test plug-in
 *
...
static int api_subscriber_enable_disable (vat_main_t * vam)
{
  ...
  M(SUBSCRIBER_ENABLE_DISABLE, mp);
...
/*
 * List of messages that the subscriber test plugin sends,
